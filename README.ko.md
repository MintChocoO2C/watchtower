...
- [x] **Phase 1** — 모드 관리, 키 시퀀스 버퍼, 숫자 prefix, HUD
- [x] **Phase 2** — 스크롤, 네비게이션, 히스토리, 리로드
- [x] **Phase 3** — 링크 힌트 (`f` / `F` / `yf`), Shadow DOM 지원
- [ ] **Phase 4** — 페이지 내 찾기 (`/`, `n` / `N`) + Visual 모드
- [ ] **Phase 5** — 탭 조작 (`J` / `K`, `t`, `x`, `X`)
- [ ] **Phase 6** — 사이트별 비활성화, 사용자 정의 키매핑, Vomnibar
