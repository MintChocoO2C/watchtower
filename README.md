...
- **Chat**: in focus view a chat handle sits at the screen edge. Hover it and the chat slides in; move the mouse over the video and it hides again. It embeds Chzzk's pop-out chat, so you can type when signed in. Pick the edge (left/right) in the settings drawer.
